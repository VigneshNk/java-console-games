...
public class Checkers {
  ...
  public static void PrintRules() {
    System.out.println(
        "1. You and your opponent will each start with 12 checkers pieces on your respective side.");
    ...
    System.out.println(
        "4. If you diagonally jump over an opponent's piece and land in a straight line, you capture"
            + "your opponent's piece removing it from the game.");
    System.out.println(
        "5. If one of your pieces reaches the opposite side of the board, your piece will become a "
